...
module.exports = function updateOneRecord (req, res) {
  ...
  for (var e in queryOptions.valuesToSet) {
    if (queryOptions.valuesToSet.hasOwnProperty(e)) {
      if(typeof queryOptions.valuesToSet[e] === "object") {
        if(queryOptions.valuesToSet[e]) queryOptions.valuesToSet[e] = queryOptions.valuesToSet[e].id;
      }
    }
  }
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
